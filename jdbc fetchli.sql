...
-- 1. Ornek: number_of_employees değeri ortalama çalışan sayısından 
...
SELECT * FROM companies;
-- 1. Ornek: Prepared statement kullanarak company adı IBM olan 
--  number_of_employees değerini 9999 olarak guncelleyin.
UPDATE companies
