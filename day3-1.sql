...
--sınav notu 85 den buyuk talebe bilgilerini getirin
select * from talebeler where yazili_notu>85;

-- ismi Mustafa Bak olan öğrenci bilgileri 
...
-- Maasi 70000 veya ismi Sena Beyaz olan personelleri listele
...
-- Maasi 70000, 100000 olan personeli listele
...
-- Ismi 2. harfi e olan personeli listele
